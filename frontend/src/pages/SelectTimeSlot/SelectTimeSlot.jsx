...
const SelectTimeSlot = () => {
  ...
  const requestingStudentId = user?.studentProfile;
  ...
  useEffect(() => {
    ...
    fetchOptions();
  }, [sessionId, requestingStudentId, token]);
      ...
      if (data.success) {
        alert(
          isAvailabilityRequest
            ? "Rescheduling request sent successfully!"
  ...
  const isSelected = (o) =>
    ...
    ((o.type === "availability" &&
      o.start === selectedOption.start &&
      o.end === selectedOption.end &&
      o.date === selectedOption.date) ||
      (o.type === "session" &&
        o.sessionId === selectedOption.sessionId));
          ...
          {sessions.map((s, idx) => (
            ...
            >
              ...
              <div className="session-body">
                ...
                <p className="session-time">{s.start} - {s.end}</p>
                <p className="session-capacity">{s.enrolled}/{s.capacity} students</p>
              </div>
            </div>
          ))}
        </div>
